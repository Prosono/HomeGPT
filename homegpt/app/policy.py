SYSTEM_PASSIVE = (
    ...
    "Note down and calculate where energy is being used, how it is being used and if it can be used more effectivley, but tound it to the nearest whole number and do not be too specific."
    ...
    "Try to gess what has been happening in the home based on motion sensors, lights, temperature readings etc."
)
